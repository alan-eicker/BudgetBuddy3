...
export type AddExpenseGroupMutation = {
  __typename?: 'Mutation';
  expenseGroup?: void | null;
};
...
export type UpdateExpensePaidStatusMutation = {
  __typename?: 'Mutation';
  updateExpensePaidStatus?: void | null;
};
...
export type GetExpenseGroupByIdQuery = {
  __typename?: 'Query';
  expenseGroup: {
    __typename?: 'ExpenseGroup';
    _id?: string | null;
...
export function getSdk(
  ...
  return {
    addExpenseGroup(
      variables: AddExpenseGroupMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<AddExpenseGroupMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddExpenseGroupMutation>(
            AddExpenseGroupDocument,
            variables,
    ...
    deleteExpenseGroup(
      variables: DeleteExpenseGroupMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<DeleteExpenseGroupMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteExpenseGroupMutation>(
            DeleteExpenseGroupDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'deleteExpenseGroup',
    ...
    deleteExpense(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteExpenseMutation>(
    ...
    updateExpense(
      variables: UpdateExpenseMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UpdateExpenseMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateExpenseMutation>(
    ...
    updateExpensePaidStatus(
      variables: UpdateExpensePaidStatusMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UpdateExpensePaidStatusMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateExpensePaidStatusMutation>(
            UpdateExpensePaidStatusDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'updateExpensePaidStatus',
    ...
    updateExpenseGroup(
      variables: UpdateExpenseGroupMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UpdateExpenseGroupMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateExpenseGroupMutation>(
            UpdateExpenseGroupDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'updateExpenseGroup',
    ...
    getAllExpenseGroups(
      variables?: GetAllExpenseGroupsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetAllExpenseGroupsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllExpenseGroupsQuery>(
            GetAllExpenseGroupsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'getAllExpenseGroups',
    ...
    getExpenseGroupById(
      variables: GetExpenseGroupByIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetExpenseGroupByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetExpenseGroupByIdQuery>(
            GetExpenseGroupByIdDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'getExpenseGroupById',
    ...
    authenticateUser(
      variables: AuthenticateUserQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<AuthenticateUserQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AuthenticateUserQuery>(
    ...
    logoutUser(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<LogoutUserQuery>(LogoutUserDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'logoutUser',
